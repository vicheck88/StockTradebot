...
CODES = [
    ("000240", "한국앤컴퍼니"), ("000660", "SK하이닉스"), ("000990", "DB하이텍"),
    ("001450", "현대해상"), ("003230", "삼양식품"), ("005690", "파미셀"),
    ("005930", "삼성전자"), ("006910", "보성파워텍"), ("017510", "세명전기"),
    ("017800", "현대엘리베이터"), ("021240", "코웨이"), ("023590", "다우기술"),
    ("030000", "제일기획"), ("039200", "오스코텍"), ("064350", "현대로템"),
    ("065710", "서호전기"), ("071050", "한국금융지주"), ("082920", "비츠로셀"),
    ("088130", "동아엘텍"), ("089970", "브이엠"), ("095610", "테스"),
    ("096530", "씨젠"), ("161390", "한국타이어앤테크놀로지"), ("171090", "선익시스템"),
    ("192400", "쿠쿠홀딩스"), ("206650", "유바이오로직스"), ("278470", "에이피알"),
    ("326030", "SK바이오팜"), ("417790", "트루엔"),
]
