...
priceWith200MA<-priceWith200MA[,getTQQQInvestRatio(.SD)]
priceWith200MA[,CashinvestRatio:=1-TQQQinvestRatio]
priceWith200MA<-as.xts(priceWith200MA)

Tactical = Return.portfolio(rets[,c("TQQQ.Adjusted","Cash")], priceWith200MA[,c("TQQQinvestRatio","CashinvestRatio")], verbose = TRUE)
